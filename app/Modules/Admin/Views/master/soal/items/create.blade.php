<div class="modal-header">
  <h4 class="modal-title" id="">Tambah Soal</h4>
  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
</div>
<form method="post" id="form-soal" action="{{ route('soal.item.store',['uuid'=>$uuid]) }}">
  {{ csrf_field() }}
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <textarea name="soal" id="soal" rows="8" class="form-control" placeholder="Tulis soal disini..."></textarea>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-6" id="acak-wrap">
        <div class="form-group">
