    ...
    <div class="card">
      <div class="card-header card-header-primary">
        <div class="pull-left">
          ...
          <p class="card-category">Menambah, Mengubah, dan Menghapus Data Mata Pelajaran</p>
        </div>
        <div class="pull-right">
          <a href="#" class="btn btn-sm btn-warning" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#modalEdit" data-url="{{ route('master.mapel.create') }}"><i class="material-icons">add</i> Tambah Mata Pelajaran</a>
        </div>
      </div>
      <div class="card-body">
...
<td>{{ (($index-1)*30)+$key+1 }}</td>
                    ...
                    <td style="white-space: nowrap;width: 50px" class="text-right">
                      <a class="btn btn-sm btn-xs btn-info" title="Ubah" href="#" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#modalEdit" data-url="{{ route('master.mapel.edit',['uuid'=>$v->uuid]) }}" class="text-info"><i class="material-icons">edit</i></a>
                      <a class="btn btn-sm btn-xs btn-danger delete" title="Hapus" data-text="{{ $v->nama }}" href="#" data-url="{{ route('master.mapel.destroy',['uuid'=>$v->uuid]) }}"><i class="material-icons">delete</i></a>
                    </td>
                  </tr>
                @endforeach
              @else
