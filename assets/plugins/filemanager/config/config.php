...
$config = array(
	...
	*******************/
	...
	'fixed_path_from_filemanager'             => array( '../featured/', '../featured/' ), //fixed path of the image folder from the current position on upload folder
	'fixed_image_creation_name_to_prepend'    => array( '', '' ), //name to prepend on filename
	'fixed_image_creation_to_append'          => array( '-600x400', '-1400x800' ), //name to appendon filename
	'fixed_image_creation_width'              => array( 600, 1400 ), //width of image
	'fixed_image_creation_height'             => array( 400, 800 ), //height of image
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	*/
	...
	'relative_path_from_current_pos'          => array( '../featured/', '../featured/' ), //relative path of the image folder from the current position on upload folder
	'relative_image_creation_name_to_prepend' => array( '', '' ), //name to prepend on filename
	'relative_image_creation_name_to_append'  => array( '-featured-sm', '-featured-lg' ), //name to append on filename
	'relative_image_creation_width'           => array( 300, 600 ), //width of image
	'relative_image_creation_height'          => array( 200, 400 ), //height of image
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
